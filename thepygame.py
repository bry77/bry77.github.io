...
#used youtube tutorial by syntdex
...
def draw_bombs(b_x, b_y, bw, bh):
    pygame.draw.rect(game_display, BLACK, [b_x[0], b_y[0], bw, bh])
    pygame.draw.rect(game_display, BLACK, [b_x[1], b_y[1], bw, bh])
    pygame.draw.rect(game_display, BLACK, [b_x[2], b_y[2], bw, bh])
    pygame.draw.rect(game_display, BLACK, [b_x[3], b_y[3], bw, bh])
...
def game_loop():
    ...
    while running:
        ...
        if 200:
            pygame.draw.rect(game_display, BLACK, [left_bombs_x[0], left_bombs_y[0], block_size, block_size])
            pygame.draw.rect(game_display, BLACK, [left_bombs_x[1], left_bombs_y[1], block_size, block_size])
            pygame.draw.rect(game_display, BLACK, [left_bombs_x[2], left_bombs_y[2], block_size, block_size])
            pygame.draw.rect(game_display, BLACK, [left_bombs_x[3], left_bombs_y[3], block_size, block_size])
            if score >= 300:
                pygame.draw.rect(game_display, BLACK, [down_bombs_x[0], down_bombs_y[0], block_size, block_size])
                pygame.draw.rect(game_display, BLACK, [down_bombs_x[1], down_bombs_y[1], block_size, block_size])
                pygame.draw.rect(game_display, BLACK, [down_bombs_x[2], down_bombs_y[2], block_size, block_size])
                pygame.draw.rect(game_display, BLACK, [down_bombs_x[3], down_bombs_y[3], block_size, block_size])
                if score >= 500:
                    pygame.draw.rect(game_display, BLACK, [right_bombs_x[0], right_bombs_y[0], block_size, block_size])
                    pygame.draw.rect(game_display, BLACK, [right_bombs_x[1], right_bombs_y[1], block_size, block_size])
                    pygame.draw.rect(game_display, BLACK, [right_bombs_x[2], right_bombs_y[2], block_size, block_size])
                    pygame.draw.rect(game_display, BLACK, [right_bombs_x[3], right_bombs_y[3], block_size, block_size])
...
#made the background change color
#added side scrolling bombs
#added a score display
#added a little diagonal bonus that if you catch you get 10 points
